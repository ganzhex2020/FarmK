 ...
 */
class GcDetailViewModel(val remoteRepo: RemoteDataSource) : BaseViewModel() {
    
    val gcDetailLiveData = MutableLiveData<List<AccountDetailEntity>>()

    fun getGcDetail(pageIndex: Int,index:Int) {
