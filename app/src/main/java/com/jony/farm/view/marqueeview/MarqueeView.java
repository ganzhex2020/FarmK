 ...
 */
public class MarqueeView extends SurfaceView implements SurfaceHolder.Callback,MarqueeLifecycleObserver{
...
//        mTextPaint.setShadowLayer(5, 3, 3, ShadowColor);
    ...
    public MarqueeView addMarqueeLifecycleObserver(LifecycleOwner owner) {
        if (owner != null) {
            owner.getLifecycle().addObserver(new MarqueeLifecycleObserverAdapter(owner, this));
        }
        return this;
    }
